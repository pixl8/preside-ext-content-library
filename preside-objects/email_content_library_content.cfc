...
component  {
	...
	property name="alternatives" relationship="one-to-many" relatedTo="content_library_conditional_alternative" relationshipKey="content_library_content" cloneable=true;
}